//! Public API tests for VirtualList core
//!
//! These tests use only public APIs of the VirtualList widget.

use revue::widget::data::virtuallist::{ScrollAlignment, ScrollMode, VirtualList};
