...
pub fn examples() -> Vec<Example> {
    ...
    vec![
        ...
        Example::new(
            "Event Calendar",
            "Calendar with event markers and details",
        ...
        Example::new(
            "Date Picker",
            "Interactive date selection widget",
        ...
        Example::new(
            "Multi-Month",
            "Side-by-side display of multiple months",
        ...
        Example::new(
            "Activity Heatmap",
            "GitHub-style contribution heatmap display",
