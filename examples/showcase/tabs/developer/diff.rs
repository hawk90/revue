...
pub fn examples() -> Vec<Example> {
    ...
    vec![
        Example::new(
            "Diff Viewer",
            "Side-by-side and unified diff with syntax highlighting",
            render_diff_viewer(&primary, &error, &success, &muted),
        ),
        Example::new(
            "Git Diff",
            "Git integration with commit info and file changes",
        ...
        Example::new(
            "Line Numbers",
            "Diff display with line references and jump-to-line",
        ...
        Example::new(
            "Change Summary",
            "File statistics with insertion and deletion counts",
        ...
        Example::new(
            "Merge Conflict",
            "Conflict marker display with resolution options",
