...
pub fn examples() -> Vec<Example> {
    ...
    vec![
        Example::new(
            "HTTP Client",
            "REST API client with URL input and method selector",
        ...
        Example::new(
            "GET Request",
            "Fetch data with query parameters and JSON response",
    ...
    "users": [
        ...
        Example::new(
            "POST Request",
            "Create resources with JSON body and form data",
    ...
    "email": "charlie@example.com"
        ...
        Example::new(
            "Response Viewer",
            "View response status, headers, and body preview",
        ...
        Example::new(
            "Error Response",
            "Error handling with status colors and error messages",
    ...
    "code": "USER_404"
        ...
        Example::new(
            "Request History",
            "Request log with response times and replay option",
