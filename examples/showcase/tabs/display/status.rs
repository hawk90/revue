...
pub fn examples(frame: u64) -> Vec<Example> {
    ...
    vec![
                ...
                vstack()
                    ...
                    .child(
                        hstack()
                            ...
                            .child(Spinner::new().style(SpinnerStyle::Dots).label("Processing"))
                            .child(Spinner::new().style(SpinnerStyle::Line).label("Syncing")),
                    )
                    .child(Text::new(""))
        ...
        Example::new(
            "Gauges",
            "Visual percentage display with threshold coloring",
        ...
        Example::new(
            "Digits",
            "Large digit display for timers, counters, and percentages",
                        ...
                        hstack()
                            ...
                            .child(
                                vstack().gap(1).child(Text::new("CPU:").fg(muted)).child(
                                    threshold_gauge(0.42, "42%", success, error, surface, 0.8),
                                ),
                            )
                            .child(
                                vstack()
