...
## [3.0.0](https://github.com/hawk90/revue/compare/v2.58.10...v3.0.0) (2026-03-19)
...
* add comprehensive unit tests for canvas braille modules ([#326](https://github.com/hawk90/revue/issues/326)) ([445b524](https://github.com/hawk90/revue/commit/445b5244199c9934899d01630b1e5a23acef1f72))
...
* add Interactive trait and focus indicators to Switch, Link, Select ([#452](https://github.com/hawk90/revue/issues/452)) ([c671115](https://github.com/hawk90/revue/commit/c671115fe73bcdb9b55a39c52b01052af6ea3e72))
...
* add z-index, error boundary, form errors, tree enhancements, undo stack, multi-sort, focus indicators, container queries, and calc() ([#446](https://github.com/hawk90/revue/issues/446)) ([98ee910](https://github.com/hawk90/revue/commit/98ee910d93d05842b4b889b11143badfb28edf01))
...
* **css:** implement padding/margin shorthand parsing ([50aef3a](https://github.com/hawk90/revue/commit/50aef3a371f34c06704dd371219a1107c5d83ebc)), closes [#180](https://github.com/hawk90/revue/issues/180)
* **event:** add double-click and triple-click detection ([b0a5ee7](https://github.com/hawk90/revue/commit/b0a5ee7419dd9563b3eadcb006b0d3484fc9b2b3)), closes [#167](https://github.com/hawk90/revue/issues/167)
...
* **layout:** add dock manager for IDE-style layouts ([#309](https://github.com/hawk90/revue/issues/309)) ([0695eac](https://github.com/hawk90/revue/commit/0695eacdbdd51c6b7f4aa1e828f03ec0274b7483)), closes [#193](https://github.com/hawk90/revue/issues/193)
* **layout:** add min/max size constraints to remaining layout widgets ([#456](https://github.com/hawk90/revue/issues/456)) ([fec03c8](https://github.com/hawk90/revue/commit/fec03c818842de39360b7d730f93eed11014f67d))
...
* **render:** switch all draw_* methods to relative coordinates ([#462](https://github.com/hawk90/revue/issues/462)) ([f2711ba](https://github.com/hawk90/revue/commit/f2711ba4d4cc3a44edfe6a1481b153e6b372b7e3))
* **security:** harden FilePicker security validation ([#337](https://github.com/hawk90/revue/issues/337)) ([e53e210](https://github.com/hawk90/revue/commit/e53e210628c71d71a31e259cdac20183399a27b1))
...
* **style:** add CSS [@keyframes](https://github.com/keyframes) and animation property parsing ([#432](https://github.com/hawk90/revue/issues/432)) ([233cbf1](https://github.com/hawk90/revue/commit/233cbf131415e4317fd86bb6a771225a8083fbc4))
...
* **style:** add REVERSE text modifier ([#63](https://github.com/hawk90/revue/issues/63)) ([0c325f4](https://github.com/hawk90/revue/commit/0c325f4adef41c6619c8d3454a986b269854e331)), closes [#51](https://github.com/hawk90/revue/issues/51)
...
* v2.0.0 - Optional deps, widgets, and maintenance CI ([#26](https://github.com/hawk90/revue/issues/26)) ([8a15e13](https://github.com/hawk90/revue/commit/8a15e1371157812f8db6ac1f8ed55ee92018a14b))
...
* **widget:** complete unreachable code and verify implementations ([#220](https://github.com/hawk90/revue/issues/220)) ([edb3757](https://github.com/hawk90/revue/commit/edb3757df789bc40b2159a370163fb59e9dbfa38))
...
* add codecov token to coverage job ([b203397](https://github.com/hawk90/revue/commit/b2033972729b586257df951c6225cc2e88fbca20))
...
* batch fix 12 critical bugs ([#211](https://github.com/hawk90/revue/issues/211)) ([4ba5f40](https://github.com/hawk90/revue/commit/4ba5f40eae4c3732c533c050e093c49f31c838ef))
* **cd:** add issues permission and package-name for release-please ([29fada5](https://github.com/hawk90/revue/commit/29fada5d27989f33db678f0518472500babf0e6a))
* **cd:** add pull-requests permission for release-please ([18db699](https://github.com/hawk90/revue/commit/18db6998aea1b5c50e9f0fc61af927a190775b03))
* **cd:** remove invalid package-name option ([36b0bae](https://github.com/hawk90/revue/commit/36b0bae23e32f9063590de0b563c202bfe6126fa))
* **cd:** use PAT for release-please ([d07c0e7](https://github.com/hawk90/revue/commit/d07c0e7117bd76984a2729c2fbc2640538fa956d))
* **ci:** add commitlint config and update typos ignore list ([#30](https://github.com/hawk90/revue/issues/30)) ([08d4249](https://github.com/hawk90/revue/commit/08d4249dc577f24605ceea812f12a61760972540))
...
* **ci:** run tests for coverage instead of lib-only ([abaeccc](https://github.com/hawk90/revue/commit/abaeccc23004061f287a939ab0359cabab1099a6))
...
* clippy warnings and format issues ([#28](https://github.com/hawk90/revue/issues/28)) ([b099665](https://github.com/hawk90/revue/commit/b099665df0d9a4e5dae82c600e4bd7f52e973796))
...
* configure trusted publishing for crates.io ([05ed7da](https://github.com/hawk90/revue/commit/05ed7dab19bd62115a6fbf00a047884d7acd8456))
...
* **docs:** correct GitHub URL and remove broken links ([ef958d4](https://github.com/hawk90/revue/commit/ef958d4ba5de7c892752120518af61f81859f642))
...
* enable revue-macros publishing and add version to dependency ([8f40cf6](https://github.com/hawk90/revue/commit/8f40cf6ed67d01ea08a08b58d17789aaa88ea389))
...
* harden clipboard operations against abuse ([292da84](https://github.com/hawk90/revue/commit/292da8435a4303dc87a94c2e3d6304184387b588))
* harden undo/redo and layout against abuse ([ca97fa3](https://github.com/hawk90/revue/commit/ca97fa3d06f8095aa3ad0ed886a8442103420937))
...
* implement graceful recovery for lock poisoning ([#263](https://github.com/hawk90/revue/issues/263)) ([4e423d3](https://github.com/hawk90/revue/commit/4e423d32db1d916f6dd4972975368d4b9311969b)), closes [#237](https://github.com/hawk90/revue/issues/237)
* improve code quality and error handling ([#305](https://github.com/hawk90/revue/issues/305)) ([0644a30](https://github.com/hawk90/revue/commit/0644a306749d01c8828b58eec913fe0ea4d5d8b8))
* include CSS themes in package ([7fc1155](https://github.com/hawk90/revue/commit/7fc1155ae124b16a30f1de69c85bd04868ed1150))
* include examples and benches in published package ([947ec57](https://github.com/hawk90/revue/commit/947ec57d0aadfa7d0d72f8b69708a9dc0672c337))
...
* **macosros:** add publish=false and sync version ([#298](https://github.com/hawk90/revue/issues/298)) ([f6f91f3](https://github.com/hawk90/revue/commit/f6f91f3721f897a462380ad2f50b973565cc6c05))
...
* prefix unused variable with underscore ([008dd76](https://github.com/hawk90/revue/commit/008dd7638a3747d175f29d752ffe5c8d62bfe0b9))
* **publish:** add CARGO_REGISTRY_TOKEN from auth action ([7d1b638](https://github.com/hawk90/revue/commit/7d1b638a43f51b1213da524d31ac59f338ea03e9))
* **publish:** add OIDC token for trusted publishing ([3615ec1](https://github.com/hawk90/revue/commit/3615ec1dede90c16418b5fa7a9d1270bb6544528))
* **publish:** use official crates-io-auth-action for trusted publishing ([c9affa0](https://github.com/hawk90/revue/commit/c9affa0466adcfb963cf97ccf1b93b6b1711bb53))
...
* **reactive:** use thread-safe shared state in use_async_poll ([#207](https://github.com/hawk90/revue/issues/207)) ([2ef5261](https://github.com/hawk90/revue/commit/2ef5261290e32d49cedc74102d9c299ea322a782)), closes [#149](https://github.com/hawk90/revue/issues/149)
* remove binary build for library crate ([8162d2a](https://github.com/hawk90/revue/commit/8162d2a82d723d75d965644391ad80935343b7ff))
* remove environment from publish job for trusted publishing ([b1dcf65](https://github.com/hawk90/revue/commit/b1dcf65f97fb0ca67405b170fdf540f4f4df3548))
...
* **render:** barchart negative values, heatmap contrast, checkbox disabled state ([#475](https://github.com/hawk90/revue/issues/475)) ([1bc0170](https://github.com/hawk90/revue/commit/1bc0170d8a9ad90ca49d7e742277216d6a6b85f0))
* **render:** color_picker double-offset and test coverage gaps ([#464](https://github.com/hawk90/revue/issues/464)) ([45430ef](https://github.com/hawk90/revue/commit/45430efd366cff12e00d736b9b00a939dad01efc))
...
* **render:** runtime bugs and deduplicate char_width rendering loops ([#484](https://github.com/hawk90/revue/issues/484)) ([ee02d6b](https://github.com/hawk90/revue/commit/ee02d6b206db66689f6104aca83cf21c9acb48ed))
...
* replace panics with proper error handling and fix flaky tests ([#259](https://github.com/hawk90/revue/issues/259)) ([840f937](https://github.com/hawk90/revue/commit/840f93703a3ef0abdf20a5019620ca6dd7bc6978))
* resolve clippy warnings in examples ([37a9e7b](https://github.com/hawk90/revue/commit/37a9e7bf7ebd70adf0ade3739aaf5ea561389810))
...
* resolve critical security issues ([#417](https://github.com/hawk90/revue/issues/417)) ([9472502](https://github.com/hawk90/revue/commit/9472502ade15f1c910d2e349e07c49f9354ce248))
* **safety,image,a11y,publish:** safety improvements and publishing fixes ([#294](https://github.com/hawk90/revue/issues/294)) ([0c9db78](https://github.com/hawk90/revue/commit/0c9db7869ca928fdc87e181b6a06ad05edc31ea6))
* **safety,text:** unwrap removal, text width, and worker improvements ([#290](https://github.com/hawk90/revue/issues/290)) ([13e22e1](https://github.com/hawk90/revue/commit/13e22e1ad3bed2cf0174154309d8ab2ece38e5fd))
* **security,perf:** harden path validation, optimize queries, and fix edge cases ([#351](https://github.com/hawk90/revue/issues/351)) ([a3ff8db](https://github.com/hawk90/revue/commit/a3ff8db09fcb70340cfec33f4a65db0c1b97b79a))
...
* **security:** add URL validation to prevent command injection ([#331](https://github.com/hawk90/revue/issues/331)) ([d0828e1](https://github.com/hawk90/revue/commit/d0828e1d887b640c3285672d52746d0dc1ba919c))
...
* **security:** comprehensive security and bug fixes ([#374](https://github.com/hawk90/revue/issues/374)) ([db2aed4](https://github.com/hawk90/revue/commit/db2aed4d769a0716109529f7cd7aaa952eed6c68))
* **security:** fix command injection in accessibility backends ([#340](https://github.com/hawk90/revue/issues/340)) ([4003704](https://github.com/hawk90/revue/commit/40037047400b44224ee131665c404ac4876b448f))
...
* **security:** improve error handling and performance ([#421](https://github.com/hawk90/revue/issues/421)) ([d4d279a](https://github.com/hawk90/revue/commit/d4d279a24b833b71825a032cb4a5e431ff489702))
...
* **security:** validate non-existent paths in validate_within_base ([51f35b5](https://github.com/hawk90/revue/commit/51f35b5f99a432aff70daa33a6e6c47766efd8c6))
...
* **text:** remove non-existent strikethrough from test ([168eb21](https://github.com/hawk90/revue/commit/168eb2191c2cfcb569ed5dc056442637b8aa8baf))
...
* use API token for crates.io publish ([140aa3c](https://github.com/hawk90/revue/commit/140aa3cee91c7f60965ecfdd9de0e2daa01d01d0))
...
* **widget:** prevent panic in Modal when width/height ≤ 2 ([#201](https://github.com/hawk90/revue/issues/201)) ([8708ce9](https://github.com/hawk90/revue/commit/8708ce9b89e9e3adb7c93f18087daf72e1592954)), closes [#154](https://github.com/hawk90/revue/issues/154)
...
* wire up unimplemented UI/UX features and fix dead code ([#448](https://github.com/hawk90/revue/issues/448)) ([cb8798a](https://github.com/hawk90/revue/commit/cb8798aab5e951191e91000d97a043681b21ca49))


### Performance Improvements

* add benchmark suite for reactive updates ([#276](https://github.com/hawk90/revue/issues/276)) ([9c58314](https://github.com/hawk90/revue/commit/9c58314b5bf43753826eef9f58d6beb0cfe50305)), closes [#255](https://github.com/hawk90/revue/issues/255)
* code quality and performance optimizations ([#376](https://github.com/hawk90/revue/issues/376)) ([531fe68](https://github.com/hawk90/revue/commit/531fe688f0233c1db09f1d0b4d05cbadc1081d18))
...
* **dom:** use Vec::with_capacity in StyleResolver::match_node ([#266](https://github.com/hawk90/revue/issues/266)) ([b798ecf](https://github.com/hawk90/revue/commit/b798ecffaf84980e0f1f70669d533a94179d614a))
...
* **perf:** 6 critical performance and safety improvements ([0039909](https://github.com/hawk90/revue/commit/0039909a726794a4932974cddc6531064149b573))
* **perf:** 6 critical performance and safety improvements ([#354](https://github.com/hawk90/revue/issues/354)) ([c387508](https://github.com/hawk90/revue/commit/c3875082074218e0a36d5e68edbee8b022e0ebe0))
...
## [2.58.0](https://github.com/hawk90/revue/compare/v2.57.0...v2.58.0) (2026-03-01)
...
## [2.52.0](https://github.com/hawk90/revue/compare/v2.51.0...v2.52.0) (2026-02-20)
...
## [2.46.3](https://github.com/hawk90/revue/compare/v2.46.2...v2.46.3) (2026-02-17)
...
## [2.46.2](https://github.com/hawk90/revue/compare/v2.46.1...v2.46.2) (2026-02-17)
...
## [2.46.1](https://github.com/hawk90/revue/compare/v2.46.0...v2.46.1) (2026-02-17)
...
## [2.44.10](https://github.com/hawk90/revue/compare/v2.44.9...v2.44.10) (2026-02-01)
...
## [2.44.1](https://github.com/hawk90/revue/compare/v2.44.0...v2.44.1) (2026-01-31)
...
## [2.43.0](https://github.com/hawk90/revue/compare/v2.42.4...v2.43.0) (2026-01-31)
...
## [2.36.1](https://github.com/hawk90/revue/compare/v2.36.0...v2.36.1) (2026-01-25)
...
## [2.36.0](https://github.com/hawk90/revue/compare/v2.35.0...v2.36.0) (2026-01-25)
...
## [2.35.0](https://github.com/hawk90/revue/compare/v2.34.1...v2.35.0) (2026-01-25)
...
## [2.34.1](https://github.com/hawk90/revue/compare/v2.34.0...v2.34.1) (2026-01-24)
...
### Changed
- Development builds now use `2.33.4-SHA` format for precise version tracking

### Refactoring
- **widgets:** split large widget files into focused submodules
- **markdown:** improve blockquote and admonition handling
- **textarea:** add default selection background color
- **tests:** add feature guards, fix slow worker pool test

## [2.33.4](https://github.com/hawk90/revue/compare/v2.33.3...v2.33.4) (2026-01-22)
...
## [2.33.3](https://github.com/hawk90/revue/compare/v2.33.2...v2.33.3) (2026-01-22)
...
## [2.31.12](https://github.com/hawk90/revue/compare/v2.31.11...v2.31.12) (2026-01-16)
