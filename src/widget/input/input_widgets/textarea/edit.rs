...
mod tests {
    ...
    // =========================================================================
    // EditOperation all variants tests
    // =========================================================================
    ...
    #[test]
    fn test_edit_operation_debug_all_variants() {
        let insert = EditOperation::Insert {
            line: 0,
            col: 0,
            text: "x".to_string(),
        ...
        assert!(format!("{:?}", insert_line).contains("InsertLine"));
        assert!(format!("{:?}", delete_line).contains("DeleteLine"));
        assert!(format!("{:?}", merge).contains("MergeLines"));
        assert!(format!("{:?}", split).contains("SplitLine"));
    }
}
