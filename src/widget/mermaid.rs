...
mod tests {
    ...
    fn test_diagram_node_color() {
        let node = DiagramNode::new("A", "Test").color(Color::RED);
        assert_eq!(node.color, Some(Color::RED));
    }

    #[test]
    fn test_diagram_node_bg() {
        let node = DiagramNode::new("A", "Test").bg(Color::BLUE);
    ...
    fn test_diagram_node_builder_chain() {
        ...
        assert_eq!(node.color, Some(Color::WHITE));
    ...
    fn test_diagram_colors() {
        ...
        colors.title = Color::RED;
        let diag = Diagram::new().colors(colors);
        assert_eq!(diag.colors.title, Color::RED);
    }
