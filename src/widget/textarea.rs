...
mod tests {
    ...
    // =========================================================================
    // Bounds Checking Tests (regression tests for #144)
    // =========================================================================

    #[test]
    fn test_bounds_check_delete_selection_multiline() {
        let mut ta = TextArea::new().content("Line1\nLine2\nLine3");
    ...
    #[test]
    fn test_bounds_check_delete_char_before_at_start() {
        let mut ta = TextArea::new().content("Hello");
        ta.set_cursor(0, 0);
    ...
    #[test]
    fn test_bounds_check_delete_char_before_merge_lines() {
        let mut ta = TextArea::new().content("Line1\nLine2");
        ta.set_cursor(1, 0);
    ...
    #[test]
    fn test_bounds_check_delete_char_at_end() {
        let mut ta = TextArea::new().content("Hello");
        ta.set_cursor(0, 5);
    ...
    #[test]
    fn test_bounds_check_delete_char_at_merge_lines() {
        let mut ta = TextArea::new().content("Line1\nLine2");
        ta.set_cursor(0, 5);
    ...
    #[test]
    fn test_bounds_check_duplicate_line() {
        let mut ta = TextArea::new().content("Hello");
        ta.set_cursor(0, 0);
    ...
    #[test]
    fn test_bounds_check_move_word_left_empty() {
    ...
    #[test]
    fn test_bounds_check_move_word_right_empty() {
        let mut ta = TextArea::new().content("");
        ta.set_cursor(0, 0);
        // Should not panic on empty content
        ta.move_word_right();
    ...
    #[test]
    fn test_bounds_check_get_word_at_cursor_empty() {
        let ta = TextArea::new().content("");
        // Internal method - test via find which uses it
        assert_eq!(ta.get_content(), "");
    }

    #[test]
    fn test_bounds_check_find_in_empty() {
        let mut ta = TextArea::new().content("");
        ta.open_find();
        ta.set_find_query("test");
    ...
    #[test]
    fn test_bounds_check_replace_multiline() {
        let mut ta = TextArea::new().content("Line1\nLine2\nLine3");
        ta.open_find();
