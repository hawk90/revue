...
// KEEP HERE: tests access private fields/methods (total_height, index_at_row, row_of_index)
#[cfg(test)]
mod tests {
    use super::*;
    ...
    // =========================================================================
    // VirtualList::get_item_height tests
    // KEEP HERE: accesses private method get_item_height (test-only, not public)
    // =========================================================================
