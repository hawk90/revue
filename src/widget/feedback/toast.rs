...
mod tests {
    ...
    fn test_toast_new_with_string() {
        ...
        let t = Toast::new(msg);
        assert_eq!(t.message, "Owned message");
    }
    ...
    fn test_toast_long_message() {
        ...
        let t = Toast::new(long_msg);
        assert_eq!(t.message.len(), 1000);
    }

    #[test]
    fn test_toast_width() {
        let t = Toast::new("Test").width(50);
        assert_eq!(t.width, Some(50));
    }
    ...
    fn test_toast_builder_chain() {
        ...
        assert_eq!(t.message, "Builder test");
        assert_eq!(t.level, ToastLevel::Warning);
        assert_eq!(t.position, ToastPosition::BottomCenter);
        assert_eq!(t.width, Some(60));
        assert!(!t.show_icon);
        assert!(t.show_border);
    }
    ...
    fn test_toast_info_method() {
        ...
        assert_eq!(t.level, ToastLevel::Info);
        assert_eq!(t.message, "Info message");
    }
    ...
    fn test_toast_success_method() {
        ...
        assert_eq!(t.message, "Success message");
    }
    ...
    fn test_toast_warning_method() {
        ...
        assert_eq!(t.level, ToastLevel::Warning);
        assert_eq!(t.message, "Warning message");
    }
